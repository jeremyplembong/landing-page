  ...
  return (
    <div className='pt-16 pb-16'>
      <div className='w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center'>
        ...
        {/* text content */}
        <div>
          <p className='text-sm sm:text-base md:text-xl font-bold text-blue-700 dark:text-pink-500'>
            About Us
          </p>
          <h1 className='text-2xl md:text-3xl lg:text-5xl mt-3 font-bold leading-[1.8rem md:leading-[3rem]'>
            Innovations Excellence Buildling Digital Future Together
          </h1>
          ...
          <div className='mt-6 grid grid-cols-1 sm:grid-cols-2 gap-6 items-center'>
            <div className='flex items-center gap-4'>
              ...
              <h1 className='test-lg sm:text-xl font-bold leading-5'>
